...
// === GUIDED SOLUTION MENU ===
// The homepage goal chooser and recommendation panel that used to live here
// were replaced by the guided menu funnel — js/funnel-data.js (configuration)
// and js/funnel.js (behaviour). Those files own the outcome → starting point →
// options → plan flow, including the guided three-question recommendation.
