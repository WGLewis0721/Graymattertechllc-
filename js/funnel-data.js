...
(function (global) {
  ...
  var plans = [
    /* ---------------- GET MORE CUSTOMERS ----------------------- */
    {
      ...
      detailUrl: 'services/business-websites',
    ...
    },
    {
      ...
      detailUrl: 'services/business-opportunity-finder',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    /* ---------------- SAVE TIME AND MONEY ---------------------- */
    {
      ...
      detailUrl: 'services/workflow-automation',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/process-documentation',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/work-from-anywhere',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/technology-cost-cleanup',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    /* ---------------- PROTECT MY BUSINESS ---------------------- */
    {
      ...
      detailUrl: 'services/business-security',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/backup-recovery',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/business-security',
      alsoUrl: 'services/backup-recovery',
    ...
    /* ---------------- HANDLE MY TECHNOLOGY --------------------- */
    {
      ...
      detailUrl: 'services/business-technology-checkup',
      price: FIT_PRICE,
      timeline: FIT_TIME,
    ...
    },
    {
      ...
      detailUrl: 'services/technology-partner',
      price: FIT_PRICE,
      timeline: FIT_TIME,
