...
# handoff model in docs/SECURITY.md ("client handoff") — and drops in a
# blank content.json matching src/schemas/content.schema.json. Every
# REPLACE placeholder must be filled in before this passes the build
