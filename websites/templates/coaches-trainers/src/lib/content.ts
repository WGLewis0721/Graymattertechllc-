...
/** coaches-trainers-only field — the ScheduleStrip data. */
...
/** coaches-trainers-only field — the TransformationSlider (shared BeforeAfterSlider) data. */
...
export interface Content {
  ...
  site?: string;
  base?: string;
  /** coaches-trainers-only field, see ScheduleStrip.astro. */
  sessions?: Session[];
  /** coaches-trainers-only field, see the TransformationSlider section in src/pages/index.astro. */
