...
/** This vertical's own extension — a single ProductShelf item (rendered via the shared ItemShowcase component). */
...
/** This vertical's own extension — the OfferBlock promotional callout. */
...
/** This vertical's own extension — the StoryPanel founder portrait + narrative. */
...
/** This vertical's own extension — one full-width tap target in LinkHub. */
...
export interface Content {
  ...
  site?: string;
  base?: string;
  /** entrepreneurs-only field, see components/shared/ItemShowcase.astro (used here as "ProductShelf"). */
  products?: Product[];
  /** entrepreneurs-only field, see src/components/OfferBlock.astro. */
  offer?: Offer;
  /** entrepreneurs-only field, see src/components/StoryPanel.astro. */
  story?: Story;
  /** entrepreneurs-only field, see src/components/LinkHub.astro. */
  links?: LinkItem[];
}
