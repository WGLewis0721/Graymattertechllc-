...
/** This vertical's own extension — featured properties for ListingCard/the page-level grid. */
...
/** This vertical's own extension — the NeighborhoodStrip data. */
...
/** This vertical's own extension — the single-agent profile, rendered via the shared BioCard. */
...
export interface Content {
  ...
  site?: string;
  base?: string;
  /** real-estate-agents-only field, see src/components/ListingCard.astro. */
  listings?: Listing[];
  /** real-estate-agents-only field, see src/components/NeighborhoodStrip.astro. */
  neighborhoods?: Neighborhood[];
  /** real-estate-agents-only field, rendered via the shared BioCard component. */
  agent?: Agent;
}
