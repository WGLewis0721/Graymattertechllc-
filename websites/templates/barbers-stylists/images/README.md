...
| `cut-1.png` through `cut-4.png` | CutGallery (SwipeGallery) | 1200x900 | 4:3 |
| `stylist-1.png` through `stylist-4.png` | StylistRoster | 600x600 | 1:1, square crop, face centered |

Minimum 4 cut photos, more is fine (just add more `gallery` entries in content.json and matching files here). One stylist photo per person on the roster.
