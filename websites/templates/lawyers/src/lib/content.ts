...
/** This vertical's own extension — one card in PracticeAreaGrid. */
...
/** This vertical's own extension — the AttorneyProfile (shared BioCard) data. */
...
/** This vertical's own extension — one entry in CaseResultsList. */
export interface CaseResult {
  summary: string;
}

/** This vertical's own extension — CaseResultsList's data plus its required disclaimer note. */
...
export interface Content {
  ...
  site?: string;
  base?: string;
  /** lawyers-only field, see PracticeAreaGrid.astro. */
  practiceAreas?: PracticeArea[];
  /** lawyers-only field, see AttorneyProfile usage of the shared BioCard in src/pages/index.astro. */
  attorney?: Attorney;
  /** lawyers-only field, see CaseResultsList.astro. */
  caseResults?: CaseResults;
  /** lawyers-only field: attorney-advertising disclaimer text, see DisclaimerBlock.astro. */
  disclaimer?: string;
}
